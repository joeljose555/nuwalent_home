...
import { SOCIAL_LINKS, SITE_EMAIL } from '../../constants'
...
const socialLinks = [
  {
    ...
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.857L1.485 2.25H8.52l4.261 5.636 5.463-5.636zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z" />
      </svg>
    ),
  },
  {
      ...
      <Container>
        <div className="py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-white/50 leading-relaxed mb-5 max-w-xs">
              Premium software development for startups, SMEs, and enterprises.
            ...
            <div className="flex items-center gap-3 mt-6">
              {socialLinks.map(({ label, href, icon }) => (
                <a
                  ...
                  className="w-8 h-8 rounded-lg bg-white/5 hover:bg-white/10 flex items-center justify-center text-white/50 hover:text-white transition-all duration-200 border border-white/10"
                >
                  {icon}
                </a>
              ))}
        ...
        <div className="py-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/30">
            &copy; {new Date().getFullYear()} Nuwalent Solutions. All rights reserved.
          </p>
          <p className="text-xs text-white/20">
            Built with precision. Shipped with pride.
          </p>
        </div>
      </Container>
    </footer>
